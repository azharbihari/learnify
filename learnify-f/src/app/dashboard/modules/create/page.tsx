...
export default function Page() {
    ...
    const addModule = async (e) => {
        ...
        setLoading(true);
        try {
            const response = await axiosInstance.post('/modules/create/', module);
    ...
    return (
        <div className="container mx-auto">
            <div className="mb-4 flex justify-between items-center">
                <div>
                    <h1 className="text-2xl font-semibold text-gray-800">Create Module</h1>
            ...
            <div className="mt-4">
                <form onSubmit={addModule} className="bg-white p-6 rounded-lg shadow-md">
                    ...
                    <div className="flex items-center justify-between">
                        <button
                            ...
                            disabled={loading}
                        >
                            {loading ? 'Please wait...' : 'Add Module'}
                        </button>
                    </div>
                </form>
            </div>
